...
export default function FileDropzone(props: Props) {
  ...
  if (!file)
    return (
      <label
        htmlFor={name}
        className="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-dashed border-primary bg-white p-6 text-center"
      >
        <svg
  ...
  return (
    <div
      className="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center rounded-xl border-2 border-dashed border-error bg-white p-6 text-center"
      onClick={(e) => {
